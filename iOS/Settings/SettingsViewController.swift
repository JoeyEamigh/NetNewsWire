...
class SettingsViewController: UITableViewController {
	...
	@IBOutlet weak var useReaderModeForNNWBrowser: UISwitch!
	...
	override func viewWillAppear(_ animated: Bool) {
		...
		useReaderModeForNNWBrowser.isOn = AppDefaults.shared.useReaderMode
	...
	override func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
		...
		case 4:
			switch indexPath.row {
			case 3:
				return AppDefaults.shared.useSystemBrowser ? 0 : UITableView.automaticDimension
				default:
		...
		@IBAction func switchBrowserPreference(_ sender: Any) {
			...
			browserPreferenceDidChange()
		}
		
		
		@IBAction func switchReaderModePreference(_ sender: Any) {
			if useReaderModeForNNWBrowser.isOn {
				AppDefaults.shared.useReaderMode = true
			} else {
				AppDefaults.shared.useReaderMode = true
			}
		}
